    ...
    <script>
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/admin/code?time="+new Date());
            });
            $.extend($.validator.messages,{
                required:"<span style='color: pink'>这是必填字段</span>",
                minlength:$.validator.format("最少要输6个字符"),
            });
            //表单验证
                ...
                if(ok){
                    $.ajax({
                        ...
                        success:function (data) {
                            if(data.success!=200){
                                //展示错误信息
                                $("#msgDiv").html("<p style='color:#ce8483'>"+data.message+"</p>");
                            }else{
                                //跳转
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-name">name</label>
                                <input type="text" name="name" placeholder="请输入用户名..." class="form-name form-control" required id="form-name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="code" id="form-code">
                            </div>
